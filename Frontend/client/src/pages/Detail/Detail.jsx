...
const Detail = () => {
  ...
  if (loading) {
    return <p className="p-10 text-center text-gray-500">Loading room details...</p>;
  }

  if (!room) {
    return <p className="p-10 text-center text-red-500">Room not found.</p>;
  }
    ...
    <div className="py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32">
        ...
        <div className="flex flex-col">
          ...
          <div className="flex flex-wrap items-center mt-3 mb-6 gap-4">
            {room.amenities.map((item, index) => (
              ...
              >
                <img
                  src={facilityIcons[item] || assets.defaultAmenityIcon}
                  alt={item}
                  className="w-5 h-5"
                />
      ...
      <div className="flex flex-col items-start gap-4">
        <div className="flex gap-4 items-center">
          ...
          />
          <div>
            <p className="text-lg md:text-xl">Hosted By ReservAi</p>
